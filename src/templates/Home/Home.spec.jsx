...
describe('<Home />', () => {
  ...
  it('should render search, posts and load more', async () => {
    render(<Home />);
    const noMorePosts = screen.getByText('This post does not exist!');
    expect.assertions(3);
    await waitForElementToBeRemoved(noMorePosts);
    const search = screen.getByPlaceholderText(/Type here your search/i);
  ...
  it('should search for posts', async () => {
    ...
    userEvent.type(search, 'This post does not exist!');
